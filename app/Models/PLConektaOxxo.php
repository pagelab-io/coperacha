...
class PLConektaOxxo extends PLConekta implements IPLPayment{
    ...
    public function createCharge(PLRequest $request)
    {
        ...
        try {
            ...
            $this->charge = \Conekta_Charge::create(array(
                ...
                'details'=> array(
                    'name'=> $person->name." ".$person->lastname, // TODO - add fullname method
                    'phone'=> $person->phone,
                    'email'=> 'logan@x-men.org',                    // TODO - fix
                    'line_items'=> array(
                        array(
