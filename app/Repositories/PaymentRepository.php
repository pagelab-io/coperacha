...
class PaymentRepository extends BaseRepository
{
    ...
    public function payment(PLRequest $request)
    {
        ...
        switch ($request->get('payment_method')) {
            ...
            case PLConstants::PAYMENT_SPEI:
                ...
                break;
            case PLConstants::PAYMENT_CARD:
                $response = $this->cardPayment($request);
                break;
    ...
    /**
     * Create a Conekta charge for CARD
     * @param PLRequest $request
     * @return PLResponse
     */
    private function cardPayment(PLRequest $request)
    {
        ...
        $response->description = "Card Payment created successfully";
        return $response;
    }
