        ...
        <nav class="navigation">
            <div class="container-fluid">
                ...
                <ul class="clearfix list hidden-xs">
                    ...
                    <li><a href="#">¿Cómo funciona?</a></li>
                    <li><a href="#">FAQS</a></li>
                    <li><a class="button" href="#">Crear mi Alcancía</a></li>
                    <li><a href="#">Entrar</a></li>
                </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 align-middle">
                                        <div class="contact-info">
                                            <h5>CONTACTO</h5>
                                            <div>Camino de los ibis #396 D22 Torre 2</div>
                                            <div>Col. San Jemo; Monterrey, Nuevo León</div>
                                            <div>64630 México</div>
                                            <div><a href="tel:8110668875">+52 811 066 88 75</a></div>
                                            <div><a href="mailto:hola@coperacha.com.mx">hola@coperacha.com.mx</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
