                        ...
                        <div class="col-sm-6">
                            <form class="form register">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5"><input id="name" class="form-control" name="name" placeholder="Nombre(s)" type="text"></div>
                                        <div class="col-sm-7"><input id="lastname" class="form-control" name="lastname" placeholder="Apellido" type="text"></div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="email">Correo Electrónico</label>
                                    <input id="email" class="form-control" name="email" placeholder="Correo Electrónico" type="email">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="usuario" class="form-control" name="usuario" placeholder="Usuario" type="text">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="confirm" class="form-control" name="confirm" placeholder="Contraseña" type="password">
                                </div>
